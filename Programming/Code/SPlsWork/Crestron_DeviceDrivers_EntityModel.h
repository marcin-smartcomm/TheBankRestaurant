namespace Crestron.DeviceDrivers.EntityModel;
        // class declarations
         ...
         class DeviceDriverConfiguration;
     ...
     class DeviceDriverConfiguration 
    {
        ...
        // class events
        EventHandler ConfigurationItemsUpdated ( DeviceDriverConfiguration sender, ConfigurationItemsUpdatedEventArgs e );
        EventHandler ConfigurationListChanged ( DeviceDriverConfiguration sender, ConfigurationListChangedEventArgs e );
